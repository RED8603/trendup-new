...
const Post = () => {
    ...
    const [isLiked, setIsLiked] = useState({ heart: true, like: false, comment: false });
    ...
    return (
        <BoxConatner sx={{ mb: 2 }}>
            ...
            <Typography color={theme.palette.text.secondary} fontWeight={400} mt={2}>
                As global markets fluctuate and inflation rises, Bitcoin continues to attract attention as a
                decentralized alternative to traditional finance. Backed by blockchain technology and a fixed supply of
                21 million coins, BTC stands as a hedge against monetary instability and centralized control. Whether
                you're a seasoned investor or just exploring crypto, understanding Bitcoin's fundamentals is more
                relevant than ever. 🚀 #Bitcoin isn't going away — it's evolving. 💡 Stay informed. Stay ahead.
            </Typography>
