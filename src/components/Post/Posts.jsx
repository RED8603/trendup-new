...
const postData = [
  {
    ...
    description:
      "Bitcoin is holding strong despite market volatility. Could a bull run be coming? 📈🚀 #Bitcoin",
  ...
  },
  {
    ...
    description:
      "Solana breaks past resistance. Is SOL ready to flip Ethereum? 🌊 #Solana #CryptoNews",
  ...
  },
  {
    ...
    description:
      "DeFi platforms are reshaping traditional banking. Which one do you trust most?",
  ...
  },
  {
    ...
    description:
      "USDT vs USDC — which stablecoin is your go-to for trading security? 💵🔐",
  ...
  },
  {
    ...
    description:
      "Which coin will dominate the AI + blockchain space in 2025? Cast your vote now! 🤖💰",
  ...
  },
  {
    ...
    description:
      "NFTs are more than JPEGs — they're smart contracts in disguise. 🎨💡 #NFTCommunity",
  ...
  },
  {
    ...
    description:
      "Litecoin halves again! Historically, this has triggered rallies. Will history repeat? ⛏️📉",
  ...
  },
  {
    ...
    description:
      "XRP lawsuit nearly settled. Could this be the start of an explosive breakout? ⚖️🚀",
